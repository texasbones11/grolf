...
class Leaderboard(models.Model):
    ...
    hole1score = models.SmallIntegerField(blank=True,null=True)
    hole2score = models.SmallIntegerField(blank=True,null=True)
    hole3score = models.SmallIntegerField(blank=True,null=True)
    hole4score = models.SmallIntegerField(blank=True,null=True)
    hole5score = models.SmallIntegerField(blank=True,null=True)
    hole6score = models.SmallIntegerField(blank=True,null=True)
    hole7score = models.SmallIntegerField(blank=True,null=True)
    hole8score = models.SmallIntegerField(blank=True,null=True)
    hole9score = models.SmallIntegerField(blank=True,null=True)
    hole10score = models.SmallIntegerField(blank=True,null=True)
    hole11score = models.SmallIntegerField(blank=True,null=True)
    hole12score = models.SmallIntegerField(blank=True,null=True)
    hole13score = models.SmallIntegerField(blank=True,null=True)
    hole14score = models.SmallIntegerField(blank=True,null=True)
    hole15score = models.SmallIntegerField(blank=True,null=True)
    hole16score = models.SmallIntegerField(blank=True,null=True)
    hole17score = models.SmallIntegerField(blank=True,null=True)
    hole18score = models.SmallIntegerField(blank=True,null=True)
