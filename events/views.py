...
def leaderboard(request, id):
	...
	front_finished_flag = 1
        ...
        name = cell_start + str(i.name.name.username) + cell_end
        if event.lock:
            checkbox = ''
        else:
            checkbox = '<td>'+'<label class="checkbox-inline"><input type ="checkbox" name="dl" value="'+str(i.name.name.username)+'"></label>'+'</td>'
	if i.hole1score == 0:
	    hole1 = cell_start + cell_end
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins1) == 1 and str(skins1[0][0]) == str(i.name.name.username)) or (len(skins1) > 1 and skins1[0][1] != skins1[1][1] and str(skins1[0][0]) == str(i.name.name.username)):
	...
	if i.hole2score == 0:
	    ...
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins2) == 1 and str(skins2[0][0]) == str(i.name.name.username)) or (len(skins2) > 1 and skins2[0][1] != skins2[1][1] and str(skins2[0][0]) == str(i.name.name.username)):
	...
	if i.hole3score == 0:
	    ...
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins3) == 1 and str(skins3[0][0]) == str(i.name.name.username)) or (len(skins3) > 1 and skins3[0][1] != skins3[1][1] and str(skins3[0][0]) == str(i.name.name.username)):
	...
	if i.hole4score == 0:
	    ...
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins4) == 1 and str(skins4[0][0]) == str(i.name.name.username)) or (len(skins4) > 1 and skins4[0][1] != skins4[1][1] and str(skins4[0][0]) == str(i.name.name.username)):
	...
	if i.hole5score == 0:
	    ...
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins5) == 1 and str(skins5[0][0]) == str(i.name.name.username)) or (len(skins5) > 1 and skins5[0][1] != skins5[1][1] and str(skins5[0][0]) == str(i.name.name.username)):
	...
	if i.hole6score == 0:
	    ...
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins6) == 1 and str(skins6[0][0]) == str(i.name.name.username)) or (len(skins6) > 1 and skins6[0][1] != skins6[1][1] and str(skins6[0][0]) == str(i.name.name.username)):
	...
	if i.hole7score == 0:
	    ...
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins7) == 1 and str(skins7[0][0]) == str(i.name.name.username)) or (len(skins7) > 1 and skins7[0][1] != skins7[1][1] and str(skins7[0][0]) == str(i.name.name.username)):
	...
	if i.hole8score == 0:
	    ...
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins8) == 1 and str(skins8[0][0]) == str(i.name.name.username)) or (len(skins8) > 1 and skins8[0][1] != skins8[1][1] and str(skins8[0][0]) == str(i.name.name.username)):
	...
	if i.hole9score == 0:
	    ...
	    finished_flag = 0
	    front_finished_flag = 0
        elif (len(skins9) == 1 and str(skins9[0][0]) == str(i.name.name.username)) or (len(skins9) > 1 and skins9[0][1] != skins9[1][1] and str(skins9[0][0]) == str(i.name.name.username)):
	...
	if i.hole10score == 0:
        ...
        elif (len(skins10) == 1 and str(skins10[0][0]) == str(i.name.name.username)) or (len(skins10) > 1 and skins10[0][1] != skins10[1][1] and str(skins10[0][0]) == str(i.name.name.username)):
	...
	if i.hole11score == 0:
	    ...
	    finished_flag = 0
	    back_finished_flag = 0
        elif (len(skins11) == 1 and str(skins11[0][0]) == str(i.name.name.username)) or (len(skins11) > 1 and skins11[0][1] != skins11[1][1] and str(skins11[0][0]) == str(i.name.name.username)):
	...
	if i.hole12score == 0:
	    ...
	    finished_flag = 0
	    back_finished_flag = 0
        elif (len(skins12) == 1 and str(skins12[0][0]) == str(i.name.name.username)) or (len(skins12) > 1 and skins12[0][1] != skins12[1][1] and str(skins12[0][0]) == str(i.name.name.username)):
	...
	if i.hole13score == 0:
	    ...
	    finished_flag = 0
	    back_finished_flag = 0
        elif (len(skins13) == 1 and str(skins13[0][0]) == str(i.name.name.username)) or (len(skins13) > 1 and skins13[0][1] != skins13[1][1] and str(skins13[0][0]) == str(i.name.name.username)):
	...
	if i.hole14score == 0:
	    ...
	    finished_flag = 0
	    back_finished_flag = 0
        elif (len(skins14) == 1 and str(skins14[0][0]) == str(i.name.name.username)) or (len(skins14) > 1 and skins14[0][1] != skins14[1][1] and str(skins14[0][0]) == str(i.name.name.username)):
	...
	if i.hole15score == 0:
	    ...
	    finished_flag = 0
	    back_finished_flag = 0
        elif (len(skins15) == 1 and str(skins15[0][0]) == str(i.name.name.username)) or (len(skins15) > 1 and skins15[0][1] != skins15[1][1] and str(skins15[0][0]) == str(i.name.name.username)):
	...
	if i.hole16score == 0:
	    ...
	    finished_flag = 0
	    back_finished_flag = 0
        elif (len(skins16) == 1 and str(skins16[0][0]) == str(i.name.name.username)) or (len(skins16) > 1 and skins16[0][1] != skins16[1][1] and str(skins16[0][0]) == str(i.name.name.username)):
	...
	if i.hole17score == 0:
	    ...
	    finished_flag = 0
	    back_finished_flag = 0
        elif (len(skins17) == 1 and str(skins17[0][0]) == str(i.name.name.username)) or (len(skins17) > 1 and skins17[0][1] != skins17[1][1] and str(skins17[0][0]) == str(i.name.name.username)):
	...
	if i.hole18score == 0:
	    ...
	    finished_flag = 0
	    back_finished_flag = 0
        elif (len(skins18) == 1 and str(skins18[0][0]) == str(i.name.name.username)) or (len(skins18) > 1 and skins18[0][1] != skins18[1][1] and str(skins18[0][0]) == str(i.name.name.username)):
	...
	if i.hole1score == 0:
        ...
        elif (len(g_skins1) == 1 and str(g_skins1[0][0]) == str(i.name.name.username)) or (len(g_skins1) > 1 and g_skins1[0][1] != g_skins1[1][1] and str(g_skins1[0][0]) == str(i.name.name.username)):
	...
	if i.hole2score == 0:
	    ...
	    g_finished_flag = 0
	    g_front_finished_flag = 0
        elif (len(g_skins2) == 1 and str(g_skins2[0][0]) == str(i.name.name.username)) or (len(g_skins2) > 1 and g_skins2[0][1] != g_skins2[1][1] and str(g_skins2[0][0]) == str(i.name.name.username)):
	...
	if i.hole3score == 0:
	    ...
	    g_finished_flag = 0
	    g_front_finished_flag = 0
        elif (len(g_skins3) == 1 and str(g_skins3[0][0]) == str(i.name.name.username)) or (len(g_skins3) > 1 and g_skins3[0][1] != g_skins3[1][1] and str(g_skins3[0][0]) == str(i.name.name.username)):
	...
	if i.hole4score == 0:
	    ...
	    g_finished_flag = 0
	    g_front_finished_flag = 0
        elif (len(g_skins4) == 1 and str(g_skins4[0][0]) == str(i.name.name.username)) or (len(g_skins4) > 1 and g_skins4[0][1] != g_skins4[1][1] and str(g_skins4[0][0]) == str(i.name.name.username)):
	...
	if i.hole5score == 0:
	    ...
	    g_finished_flag = 0
	    g_front_finished_flag = 0
        elif (len(g_skins5) == 1 and str(g_skins5[0][0]) == str(i.name.name.username)) or (len(g_skins5) > 1 and g_skins5[0][1] != g_skins5[1][1] and str(g_skins5[0][0]) == str(i.name.name.username)):
	...
	if i.hole6score == 0:
	    ...
	    g_finished_flag = 0
	    g_front_finished_flag = 0
        elif (len(g_skins6) == 1 and str(g_skins6[0][0]) == str(i.name.name.username)) or (len(g_skins6) > 1 and g_skins6[0][1] != g_skins6[1][1] and str(g_skins6[0][0]) == str(i.name.name.username)):
	...
	if i.hole7score == 0:
	    ...
	    g_finished_flag = 0
	    g_front_finished_flag = 0
        elif (len(g_skins7) == 1 and str(g_skins7[0][0]) == str(i.name.name.username)) or (len(g_skins7) > 1 and g_skins7[0][1] != g_skins7[1][1] and str(g_skins7[0][0]) == str(i.name.name.username)):
	...
	if i.hole8score == 0:
	    ...
	    g_finished_flag = 0
	    g_front_finished_flag = 0
        elif (len(g_skins8) == 1 and str(g_skins8[0][0]) == str(i.name.name.username)) or (len(g_skins8) > 1 and g_skins8[0][1] != g_skins8[1][1] and str(g_skins8[0][0]) == str(i.name.name.username)):
	...
	if i.hole9score == 0:
	    ...
	    g_finished_flag = 0
	    g_front_finished_flag = 0
        elif (len(g_skins9) == 1 and str(g_skins9[0][0]) == str(i.name.name.username)) or (len(g_skins9) > 1 and g_skins9[0][1] != g_skins9[1][1] and str(g_skins9[0][0]) == str(i.name.name.username)):
	...
	if i.hole10score == 0:
        ...
        elif (len(g_skins10) == 1 and str(g_skins10[0][0]) == str(i.name.name.username)) or (len(g_skins10) > 1 and g_skins10[0][1] != g_skins10[1][1] and str(g_skins10[0][0]) == str(i.name.name.username)):
	...
	if i.hole11score == 0:
	    ...
	    g_finished_flag = 0
	    g_back_finished_flag = 0
        elif (len(g_skins11) == 1 and str(g_skins11[0][0]) == str(i.name.name.username)) or (len(g_skins11) > 1 and g_skins11[0][1] != g_skins11[1][1] and str(g_skins11[0][0]) == str(i.name.name.username)):
	...
	if i.hole12score == 0:
	    ...
	    g_finished_flag = 0
	    g_back_finished_flag = 0
        elif (len(g_skins12) == 1 and str(g_skins12[0][0]) == str(i.name.name.username)) or (len(g_skins12) > 1 and g_skins12[0][1] != g_skins12[1][1] and str(g_skins12[0][0]) == str(i.name.name.username)):
	...
	if i.hole13score == 0:
	    ...
	    g_finished_flag = 0
	    g_back_finished_flag = 0
        elif (len(g_skins13) == 1 and str(g_skins13[0][0]) == str(i.name.name.username)) or (len(g_skins13) > 1 and g_skins13[0][1] != g_skins13[1][1] and str(g_skins13[0][0]) == str(i.name.name.username)):
	...
	if i.hole14score == 0:
	    ...
	    g_finished_flag = 0
	    g_back_finished_flag = 0
        elif (len(g_skins14) == 1 and str(g_skins14[0][0]) == str(i.name.name.username)) or (len(g_skins14) > 1 and g_skins14[0][1] != g_skins14[1][1] and str(g_skins14[0][0]) == str(i.name.name.username)):
	...
	if i.hole15score == 0:
	    ...
	    g_finished_flag = 0
	    g_back_finished_flag = 0
        elif (len(g_skins15) == 1 and str(g_skins15[0][0]) == str(i.name.name.username)) or (len(g_skins15) > 1 and g_skins15[0][1] != g_skins15[1][1] and str(g_skins15[0][0]) == str(i.name.name.username)):
	...
	if i.hole16score == 0:
	    ...
	    g_finished_flag = 0
	    g_back_finished_flag = 0
        elif (len(g_skins16) == 1 and str(g_skins16[0][0]) == str(i.name.name.username)) or (len(g_skins16) > 1 and g_skins16[0][1] != g_skins16[1][1] and str(g_skins16[0][0]) == str(i.name.name.username)):
	...
	if i.hole17score == 0:
	    ...
	    g_finished_flag = 0
	    g_back_finished_flag = 0
        elif (len(g_skins17) == 1 and str(g_skins17[0][0]) == str(i.name.name.username)) or (len(g_skins17) > 1 and g_skins17[0][1] != g_skins17[1][1] and str(g_skins17[0][0]) == str(i.name.name.username)):
	...
	if i.hole18score == 0:
	    ...
	    g_finished_flag = 0
	    g_back_finished_flag = 0
        elif (len(g_skins18) == 1 and str(g_skins18[0][0]) == str(i.name.name.username)) or (len(g_skins18) > 1 and g_skins18[0][1] != g_skins18[1][1] and str(g_skins18[0][0]) == str(i.name.name.username)):
